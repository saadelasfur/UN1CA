...
SEC_FLOATING_FEATURE_AUDIO_CONFIG_SOUNDALIVE_VERSION=eq_custom,uhq_onoff,adapt,karaoke,dvfs_700000
...
SEC_FLOATING_FEATURE_CAMERA_CONFIG_UW_DISTORTION_CORRECTION=120,109,2,21020101,4000,3000,0,0,0,0
...
SEC_FLOATING_FEATURE_COMMON_CONFIG_SWLENS_DISTORTION_CORRECTION=m52xq,IMX258
#SEC_FLOATING_FEATURE_SAIV_CONFIG_AI_REVITAL_VERSION=1.7,0
SEC_FLOATING_FEATURE_SAIV_CONFIG_AI_REVITAL_VERSION=1.7,1
SEC_FLOATING_FEATURE_SAIV_CONFIG_MIDAS=UPSCALE,LOWLIGHT,HDR,DEBLUR,MOIRE,DENOISE_DEBLUR,UPSCALE_DEBLUR,PHOTOPOLISH
SEC_FLOATING_FEATURE_VISION_CONFIG_RELIGHTING_SOLUTION=arsoft_vieweronly.v1

# Display
SEC_FLOATING_FEATURE_COMMON_CONFIG_MDNIE_MODE=65301
...
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_m52xq_sm7325
